...
// 	protoc        v6.31.1
// source: warcraft/types/guild-type.proto
...
func (x *Guild) Reset() {
	*x = Guild{}
	mi := &file_warcraft_types_guild_type_proto_msgTypes[0]
...
func (*Guild) Descriptor() ([]byte, []int) {
	return file_warcraft_types_guild_type_proto_rawDescGZIP(), []int{0}
}
...
var File_warcraft_types_guild_type_proto protoreflect.FileDescriptor

const file_warcraft_types_guild_type_proto_rawDesc = "" +
	"\n" +
	"\x1fwarcraft/types/guild-type.proto\x12\x0ewarcraft.types\"\xb8\x03\n" +
	"\x05Guild\x12\x0e\n" +
...
var (
	file_warcraft_types_guild_type_proto_rawDescOnce sync.Once
	file_warcraft_types_guild_type_proto_rawDescData []byte
)

func file_warcraft_types_guild_type_proto_rawDescGZIP() []byte {
	file_warcraft_types_guild_type_proto_rawDescOnce.Do(func() {
		file_warcraft_types_guild_type_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_warcraft_types_guild_type_proto_rawDesc), len(file_warcraft_types_guild_type_proto_rawDesc)))
	})
	return file_warcraft_types_guild_type_proto_rawDescData
}

var file_warcraft_types_guild_type_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_warcraft_types_guild_type_proto_goTypes = []any{
	(*Guild)(nil), // 0: warcraft.types.Guild
}
var file_warcraft_types_guild_type_proto_depIdxs = []int32{
...
func init() { file_warcraft_types_guild_type_proto_init() }
func file_warcraft_types_guild_type_proto_init() {
	if File_warcraft_types_guild_type_proto != nil {
		return
	}
	file_warcraft_types_guild_type_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_warcraft_types_guild_type_proto_rawDesc), len(file_warcraft_types_guild_type_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_warcraft_types_guild_type_proto_goTypes,
		DependencyIndexes: file_warcraft_types_guild_type_proto_depIdxs,
		MessageInfos:      file_warcraft_types_guild_type_proto_msgTypes,
	}.Build()
	File_warcraft_types_guild_type_proto = out.File
	file_warcraft_types_guild_type_proto_goTypes = nil
	file_warcraft_types_guild_type_proto_depIdxs = nil
}
