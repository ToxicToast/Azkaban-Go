...
type WarcraftCronjobServiceClient interface {
	SearchCharacter(ctx context.Context, in *cronjobs.Search, opts ...grpc.CallOption) (*cronjobs.Profile, error)
	SearchMedia(ctx context.Context, in *cronjobs.Search, opts ...grpc.CallOption) (*cronjobs.Media, error)
	SearchKeystoneRating(ctx context.Context, in *cronjobs.Search, opts ...grpc.CallOption) (*cronjobs.KeystoneRating, error)
	SearchGuild(ctx context.Context, in *cronjobs.Search, opts ...grpc.CallOption) (*cronjobs.Guild, error)
	SearchGuildRoster(ctx context.Context, in *cronjobs.Search, opts ...grpc.CallOption) (*cronjobs.GuildRoster, error)
}
...
func (c *warcraftCronjobServiceClient) SearchCharacter(ctx context.Context, in *cronjobs.Search, opts ...grpc.CallOption) (*cronjobs.Profile, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(cronjobs.Profile)
...
func (c *warcraftCronjobServiceClient) SearchMedia(ctx context.Context, in *cronjobs.Search, opts ...grpc.CallOption) (*cronjobs.Media, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(cronjobs.Media)
...
func (c *warcraftCronjobServiceClient) SearchKeystoneRating(ctx context.Context, in *cronjobs.Search, opts ...grpc.CallOption) (*cronjobs.KeystoneRating, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(cronjobs.KeystoneRating)
...
func (c *warcraftCronjobServiceClient) SearchGuild(ctx context.Context, in *cronjobs.Search, opts ...grpc.CallOption) (*cronjobs.Guild, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(cronjobs.Guild)
...
func (c *warcraftCronjobServiceClient) SearchGuildRoster(ctx context.Context, in *cronjobs.Search, opts ...grpc.CallOption) (*cronjobs.GuildRoster, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(cronjobs.GuildRoster)
...
type WarcraftCronjobServiceServer interface {
	SearchCharacter(context.Context, *cronjobs.Search) (*cronjobs.Profile, error)
	SearchMedia(context.Context, *cronjobs.Search) (*cronjobs.Media, error)
	SearchKeystoneRating(context.Context, *cronjobs.Search) (*cronjobs.KeystoneRating, error)
	SearchGuild(context.Context, *cronjobs.Search) (*cronjobs.Guild, error)
	SearchGuildRoster(context.Context, *cronjobs.Search) (*cronjobs.GuildRoster, error)
...
func (UnimplementedWarcraftCronjobServiceServer) SearchCharacter(context.Context, *cronjobs.Search) (*cronjobs.Profile, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SearchCharacter not implemented")
}
func (UnimplementedWarcraftCronjobServiceServer) SearchMedia(context.Context, *cronjobs.Search) (*cronjobs.Media, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SearchMedia not implemented")
}
func (UnimplementedWarcraftCronjobServiceServer) SearchKeystoneRating(context.Context, *cronjobs.Search) (*cronjobs.KeystoneRating, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SearchKeystoneRating not implemented")
}
func (UnimplementedWarcraftCronjobServiceServer) SearchGuild(context.Context, *cronjobs.Search) (*cronjobs.Guild, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SearchGuild not implemented")
}
func (UnimplementedWarcraftCronjobServiceServer) SearchGuildRoster(context.Context, *cronjobs.Search) (*cronjobs.GuildRoster, error) {
...
func _WarcraftCronjobService_SearchCharacter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WarcraftCronjobServiceServer).SearchCharacter(ctx, req.(*cronjobs.Search))
	}
...
func _WarcraftCronjobService_SearchMedia_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WarcraftCronjobServiceServer).SearchMedia(ctx, req.(*cronjobs.Search))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _WarcraftCronjobService_SearchKeystoneRating_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WarcraftCronjobServiceServer).SearchKeystoneRating(ctx, req.(*cronjobs.Search))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _WarcraftCronjobService_SearchGuild_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WarcraftCronjobServiceServer).SearchGuild(ctx, req.(*cronjobs.Search))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _WarcraftCronjobService_SearchGuildRoster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WarcraftCronjobServiceServer).SearchGuildRoster(ctx, req.(*cronjobs.Search))
	}
	return interceptor(ctx, in, info, handler)
}
